...
#define GET_CRC16_DATA(MESSAGE,LENGTH) (uint16_t)(((MESSAGE)[LENGTH-2]<<8)|(MESSAGE)[LENGTH-1]) 
...
/*生成从站应答主站的响应*/
uint16_t SyntheticSlaveAccessRespond(uint8_t *receivedMesasage,uint16_t *registerList,uint8_t *respondBytes);
#endif
